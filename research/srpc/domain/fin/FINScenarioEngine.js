    ...
    const FINScenarioEngine = {
        ...
        testDeterminism: function (
            ...
            function removeAuditTimestamp(result) {
                ...
                if (
                    ...
                    typeof result.result.result.auditLogEntry ===
                        "object"
                ) {
                    delete result.result.result.auditLogEntry.timestamp;
                }
            }

            removeAuditTimestamp(
                firstComparable
            );
        ...
        reset: function () {
            ...
            return {
                reset: false,
                reason:
                    "FINScenario reset function unavailable."
            };
        },
